...
class T5LayerSelfAttention(nn.Module):
    def __init__(self, config, has_relative_attention_bias=False):
        super().__init__()
        self.SelfAttention = T5_ATTENTION_CLASSES[config._attn_implementation](config,
...
class T5LayerCrossAttention(nn.Module):
    def __init__(self, config):
        super().__init__()
        self.EncDecAttention = T5_ATTENTION_CLASSES[config._attn_implementation](config,
